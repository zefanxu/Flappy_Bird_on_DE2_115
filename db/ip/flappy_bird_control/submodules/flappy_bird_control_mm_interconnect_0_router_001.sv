...
(
    ...
    localparam PAD1 = log2ceil(64'h1b0 - 64'h1a0); 
    localparam PAD2 = log2ceil(64'h1c0 - 64'h1b8); 
    ...
    // ( 0x1a0 .. 0x1b0 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 28'h1a0   ) begin
            src_channel = 30'b00100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 22;
    end

    // ( 0x1b8 .. 0x1c0 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 28'h1b8  && read_transaction  ) begin
